...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'lazycn@gmail.com',
  ...
  baseDirectory: process.env.BASE_DIRECTORY || '/habox',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/cntv-chat/e5habox',
    },
  ],
